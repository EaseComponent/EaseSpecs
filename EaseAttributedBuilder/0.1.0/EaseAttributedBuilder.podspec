#
# Be sure to run `pod lib lint EaseAttributedBuilder.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'EaseAttributedBuilder/Classes/**/*'
  
  # s.resource_bundles = {
  #   'EaseAttributedBuilder' => ['EaseAttributedBuilder/Assets/*.png']
  # }
